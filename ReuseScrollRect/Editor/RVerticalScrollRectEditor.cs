...
{
    [CustomEditor(typeof(RVerticalScrollRect), true)]
    [CanEditMultipleObjects]
    public class RVerticalScrollRectEditor : UnityEditor.Editor
    {
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((RVerticalScrollRect) target).transform;
