...
{
    [CustomEditor(typeof(RHorizontalScrollRect), true)]
    [CanEditMultipleObjects]
    public sealed class RHorizontalScrollRectEditor : UnityEditor.Editor
    {
        ...
        void SetAnimBools(bool instant)
        {
            SetAnimBool(m_ShowElasticity,
                ...
                m_MovementType.enumValueIndex == (int) RScrollRectBase.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((RHorizontalScrollRect) target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((RScrollRectBase.ScrollbarVisibility) m_HorizontalScrollbarVisibility.enumValueIndex ==
                    RScrollRectBase.ScrollbarVisibility.AutoHideAndExpandViewport
