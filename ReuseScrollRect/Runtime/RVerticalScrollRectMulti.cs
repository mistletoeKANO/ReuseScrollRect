...
{
    [AddComponentMenu("UI/Reuse Vertical Scroll Rect(MultiPrefab)", 53)]
    [DisallowMultipleComponent]
    public class RVerticalScrollRectMulti : RScrollRectMulti
    {
        ...
        protected override void Awake()
        {
            ...
            if (m_Content)
            {
                ...
                {
                    Debug.LogError("[RVerticalScrollRectMulti] unsupported GridLayoutGroup constraint");
                }
            }
        }
