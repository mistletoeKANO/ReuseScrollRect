...
{
    [CustomEditor(typeof(ReuseScrollRect), true)]
    [CanEditMultipleObjects]
    public class ReuseScrollRectEditor : Editor
    {
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)ReuseScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((ReuseScrollRect)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((ReuseScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == ReuseScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((ReuseScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == ReuseScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
